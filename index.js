...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-pac/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-pac -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-pac -o bitcore-lib-pac.js';
    }
